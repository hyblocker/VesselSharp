...
{
	class Vessel : ILibrary
	{
		public void Setup(Driver driver)
		{
			var options = driver.Options;
			var module = options.AddModule("Diligent");
			module.Headers.Add("SDL.h");
			options.OutputDir = "Vessel";

			var parserOptions = driver.ParserOptions;
			var sdlPath = Path.Combine(Directory.GetCurrentDirectory(), "SDL", "SDL-2.0/include");
			Console.WriteLine("Attempting to load Vessel from " + sdlPath);
