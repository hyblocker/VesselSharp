...
namespace Vessel
{
	...
	public struct Color : IEquatable<Color>
	{
		...
		public UInt32 PackedValueRGBA
		{
			get 
			{
				return (_packedValue & 0x000000FFU) << 24 | (_packedValue & 0x0000FF00U) << 8 |
				(_packedValue & 0x00FF0000U) >> 8 | (_packedValue & 0xFF000000U) >> 24;
			}
			set
			{
				_packedValue = (value & 0x000000FFU) << 24 | (value & 0x0000FF00U) << 8 |
